  ...
  "inline-flex items-center justify-center text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        four:
          "bg-white border-[1px] border-black text-slate-900 hover:bg-slate-200",
        five:
          "bg-white border-[1px] border-slate-400 text-slate-900 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
        six:
          "bg-white border-[1px] border-blue-200 text-slate-900 hover:bg-[#4169E1] hover:text-white dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
