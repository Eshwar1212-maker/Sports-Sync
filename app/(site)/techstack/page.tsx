      ...
      <div>
        <div className="space-y-8">
          ...
          <h1 className="text-3xl font-bold leading-relaxed sm:hidden">
            Synced's Tech Stack: How we're helping athletes get to the next
            level
          </h1>
          <p className="text-lg text-gray-700 leading-relaxed font-light">
            I get a lot of people asking me the specific technologies we used to
            build Synced. I thought it would be great for other athletes who
            might also be engineers to read about our stack, and what problems
            we are trying to solve in the future.
          </p>
        </div>
        ...
        <section className="py-8 space-y-8">
          ...
          <p className="text-lg text-gray-700 leading-relaxed font-light">
            ...
            into one efficient tool. These centralized features drive our
            product roadmap.
          </p>
        </section>
        ...
        <section className="py-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-700 leading-relaxed font-light">
              ...
              layout made it easier for us to keep everything organized. We have
              a separate components folder in every route and nested route, for
              example, conversations, and [conversationId] (for rendering
              dynamic one-on-one chats and group chats). We tried to put as
              little code as possible in higher level components. .Following
              this architecture throughout the app has helped us stay organized
              and dial in on whatever feature we're working on.
              <br />
              <br />
              - Rendering Performance: Due to Next.js 13's server-side
              rendering, image optimization, code splitting, and lazy loading,
              we have not had to put as much effort into optimizing performance.
              Due to this, our page loads are blazing fast, and loading states
              are shown immediately. If we did all of this with plain React, it
              would have taken much longer. We also smartly used React's useMemo
              and useCallback hooks where they were needed, to reduce
              ...
              libraries. Tailwind gave us full customization with every
              component, along with helping us style our components efficiently
              without having to constantly switch between CSS files. For
              libraries, we originally used Headless UI for a few different
              components, mainly the modals, but a new component library called
              Shadcn/ui was a life saver, offering endless customizable
              components we used.
            </p>
          </div>
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-700 leading-relaxed font-light">
              Our backend consists of Next.js 13 serverless API route handlers,
              Prisma, Pusher, and MongoDB. Prisma and MongoDB work exceptionally
              well together; while MongoDB traditionally does not support
              relations, Prisma lets you add relations to your models while also
              fully supporting typescripts type safety . Our app has many
          ...
          <p className="text-lg text-gray-700 leading-relaxed font-light">
            ...
            able to track their skill workouts, and have AI generate them
            feedback and plans. We are very excited. We plan to add many more
            features in the future; stay up to date with the progress on Github.
          </p>
          <br />
          <a
