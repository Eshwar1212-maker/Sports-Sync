...
const Second: FC<SecondProps> = ({}) => {
  return (
    <div className="flex flex-col justify-center items-center lg:flex-row bg-orange-200 pb-9">
      <div className="w-[80%] lg:w-[500px] py-20 text-center">
      <h3 className="text-gray-800 text-3xl md:text-3xl lg:text-4xl font-thin mx-auto">
