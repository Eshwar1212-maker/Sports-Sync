...
const Second: FC<SecondProps> = ({}) => {
  return (
    <div className="flex flex-col justify-center items-center lg:flex-row pb-9 xl:pl-40 bg-white">
      ...
      <h3 className="text-gray-800 text-3xl md:text-4xl lg:text-5xl mx-auto">
        ...
        <p className="text-md md:text-xl py-4 text-gray-500">
          Use our calendar to schedule all of your own events, such as practices, games, meetings, 
